use crate::{app::AppState, error::AppError, input::text::TextInjector};
                            ...
                            if shortcut == &record_shortcut {
                                ...
                                match event.state {
                                    ShortcutState::Pressed => {
                                        ...
                                        let temp_path = crate::utils::paths::get_temp_recording_path();
                                        if let Err(e) = recorder.start_recording(app_handle, temp_path) {
